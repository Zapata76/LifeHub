            ...
            <div class="modal-body-scroll">
                ...
                <div class="photo-section">
                    <div class="photo-preview-container" *ngIf="previewUrl || editingNote.image_url">
                        ...
                        <button class="remove-photo" (click)="removePhoto()" *ngIf="!isSaving">×</button>
                    </div>
          ...
          <div class="note-card card" *ngFor="let n of notes" [style.border-top-color]="n.color" (click)="editNote(n)">
            ...
            <div class="note-body">
                ...
                <div class="note-footer">
                  ...
                  <button class="delete-btn" (click)="deleteNote(n); $event.stopPropagation()">🗑️</button>
                </div>
            </div>
          </div>
        </div>
  ...
  loadNotes() {
    this.notesService.getNotes().subscribe(data => {
      ...
      if (this.notes.length > 0 && !this.userAuthor) {
          ...
          // (Questo verrà migliorato quando avremo un servizio user centralizzato)
      }
    });
  }
