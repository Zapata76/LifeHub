...
@Component({
  ...
  styles: [`
    ...
    .qty-input { width: 78px; padding: 12px; background: #121212; border: 1px solid #444; color: white; border-radius: 8px; text-align: center; }
    .add-btn { flex: 0 0 46px; background: #4f8cff; color: white; border: none; border-radius: 8px; font-size: 1.5rem; cursor: pointer; }
    ...
    .delete-btn { background: transparent; border: none; color: #ff5c5c; font-size: 1.4rem; cursor: pointer; line-height: 1; }
    ...
    .stacked-form .form-row { margin-bottom: 0; }
    .selected-label { margin-top: 8px; font-size: 0.85rem; color: #9cc0ff; }
    .clear-selection { color: #ff8b8b; cursor: pointer; margin-left: 8px; font-size: 1.1rem; }
    .clear-selection:hover { color: #ff5c5c; }
